  ...
  return (
    <div className="main-layout">
      ...
      <div className="main-content-with-sidebar">
        <div className="medicine-item-details-page">
          <div className="medicine-item-card">
            <div className="medicine-item-header">
              <h2 className="medicine-item-title">Medicine Inventory</h2>
              <div className="medicine-item-actions">
                <Link to="/medicine/add" className="medicine-item-btn primary">
                  + Add Medicine
                </Link>
              </div>
            </div>

        <div className="medicine-item-body" style={{ paddingTop: 20 }}>
          <div style={{
            ...filtersBar,
