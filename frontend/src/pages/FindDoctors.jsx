...
// Standalone Find Doctors page (no patient sidebar)
  ...
  return (
    <div className="doctors-page" style={{ paddingTop: '110px' }}>
      <div className="doctors-header">
        <h1 className="h1">Find Doctors</h1>
        <p className="p">Browse specialists and request an appointment in a few clicks.</p>
      </div>
      ...
      <div className="doctors-grid">
        {loading && (
          <div style={{ gridColumn: '1/-1', textAlign: 'center', padding: '2rem' }}>Loading doctors...</div>
        )}
        {!loading && error && (
          <div style={{ gridColumn: '1/-1', textAlign: 'center', color: '#b91c1c', padding: '2rem' }}>{error}</div>
        )}
        {!loading && !error && filteredDoctors.length === 0 && (
          <div style={{ gridColumn: '1/-1', textAlign: 'center', padding: '2rem' }}>No doctors found.</div>
        )}
        {!loading && !error &&
            ...
            <div className="doctor-card" key={idx}>
              ...
              <div style={{ display: 'flex', gap: 8, marginTop: 8, flexWrap: 'wrap', justifyContent: 'center' }}>
                <button
                  ...
                  onClick={() => navigate(`/doctors/${doc._id || idx}`, { state: { doctor: doc } })}
                ...
                <button
                  className="doctor-request-btn"
                  onClick={() => navigate('/appointments/add', { state: { doctor: doc } })}
                >
                  Request Appointment
                </button>
              </div>
