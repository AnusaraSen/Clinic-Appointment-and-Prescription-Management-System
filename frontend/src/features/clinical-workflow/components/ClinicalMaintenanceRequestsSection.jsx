...
export const ClinicalMaintenanceRequestsSection = ({ onNavigate }) => {
  const { user } = useAuth() || {};
    ...
    <div className="bg-white rounded-lg border border-gray-200">
      <div className="flex items-center justify-between p-4 border-b border-gray-100">
        <div className="flex items-center gap-2">
          <div className="p-2 rounded bg-blue-50"><Wrench className="h-4 w-4 text-blue-700"/></div>
          <div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={() => (typeof onNavigate === 'function' ? onNavigate('maintenance') : window.location.assign('/maintenance'))}
            className="px-2.5 py-1.5 text-xs rounded border bg-white hover:bg-gray-50"
          >View all</button>
        </div>
      </div>
...
export default ClinicalMaintenanceRequestsSection;
