  ...
  return (
    <div className="all-patients-wrapper">
      <div className="no-print" style={{display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'1.5rem'}}>
        <div className="apt-enhanced-title-wrapper">
          <div className="apt-title-badge">👥</div>
          <div className="apt-title-content">
            <h1 className="apt-enhanced-title mb-0">All Patients</h1>
            <p className="apt-title-subtitle mb-0">Complete Medical Records Database</p>
          </div>
        </div>
