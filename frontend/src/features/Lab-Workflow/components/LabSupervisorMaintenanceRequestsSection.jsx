...
const LabSupervisorMaintenanceRequestsSection = () => {
  const { user } = useAuth() || {};
      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="p-2 rounded bg-indigo-50"><Wrench className="h-4 w-4 text-indigo-700"/></div>
            <div>
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs rounded bg-indigo-600 text-white hover:bg-indigo-700"
...
export default LabSupervisorMaintenanceRequestsSection;
