...
export const PharmacistMaintenanceRequestsSection = () => {
  const { user } = useAuth() || {};
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      <div className="flex items-center justify-between p-4 border-b border-gray-100">
        <div className="flex items-center gap-2">
          <div className="p-2 rounded bg-purple-50"><Wrench className="h-4 w-4 text-purple-700"/></div>
          <div>
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs rounded bg-purple-600 text-white hover:bg-purple-700"
...
export default PharmacistMaintenanceRequestsSection;
