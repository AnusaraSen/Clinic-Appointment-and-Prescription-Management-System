...
import { AddMaintenanceRequestForm } from './AddMaintenanceRequestForm';
...
export const WorkRequestsTable = ({ showActions = true, showAddButton = true, onNavigate }) => {
  console.log('FEATURES WorkRequestsTable: Component rendered with props:', { showActions, showAddButton, onNavigate });
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="flex space-x-3">
            {showAddButton && (
              <button 
                ...
                onClick={() => {
                  console.log('FEATURES WorkRequestsTable: Add button clicked!');
                  console.log('FEATURES WorkRequestsTable: Current showAddForm state:', showAddForm);
                  console.log('FEATURES WorkRequestsTable: showAddButton prop:', showAddButton);
                  setShowAddForm(true);
                  console.log('FEATURES WorkRequestsTable: setShowAddForm(true) called');
                }}
              >
      ...
      {showAddForm && (
        <>
          {console.log('FEATURES WorkRequestsTable: Rendering AddMaintenanceRequestForm modal, showAddForm:', showAddForm)}
          <AddMaintenanceRequestForm
            isOpen={showAddForm}
            onClose={() => {
              console.log('FEATURES WorkRequestsTable: Closing add form modal');
              setShowAddForm(false);
            }}
      ...
      {console.log('FEATURES WorkRequestsTable render: showAddForm =', showAddForm, 'showAddButton =', showAddButton)}
